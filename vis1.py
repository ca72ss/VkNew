...
from vis0 import token, my_id, api_v, max_workers, delay, deep
...
class VkFriends():
    ...
    def friends(self, id):
        ...
        r = requests.get(self.request_url('friends.get',
                                          'user_id=%s&fields=uid,first_name,last_name,photo,country,city,sex,bdate' % id)).json()[
            'response']
...
if __name__ == '__main__':
    ...
    print(a.my_name, a.my_last_name, a.my_id, a.photo)
    # print(a.common_friends())
    #df = a.deep_friends(deep) #зайти дэбагером внутрь
    #VkFriends.save_load_deep_friends('deep_friends_dct', True, df)
    print('Done!')
